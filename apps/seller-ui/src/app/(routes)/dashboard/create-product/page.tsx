...
const Page = () => {
    ...
    const subcategories = useMemo(() => {
        return selectedCategory ? subCategoriesData
        [selectedCategory] || [] : [];
                    ...
                    <div className="w-2/4">
                            ...
                            <Input
                                ...
                                {...register("slug", {
                                    ...
                                    pattern: {
                                      value: /^[a-z0-9]+(?:-[a-z0-9]+)*$/,
                                      message:
                                        "Invalid slug format only lowrcase letters, numbers, and"
                                    },
                                    minLength: {
                                        value: 3,
                        ...
                        <div className="mt-2">
                            ...
                            <select
                                ...
                                defaultValue="yes"
                                className="w-full border outline-none border-gray-700 bg-transparent p-2 rounded-md text-white undefined"
                            >
                    ...
                    <div className="w-2/4">
                        ...
                        <div className="mt-2">
                            ...
                            <Controller 
                                name="subcategories"
                                control={control}
                                rules={{required: "Subategories is required"}}
                                render={({field}) => (
                                    <select
                                        {...field}
                                        className="w-full border outline-none border-gray-700 bg-transparent p-2 rounded-md text-white undefined"
                        ...
                        <div className="mt-2">
                            <Input 
                                label="Video URL"
                                placeholder="https://www.youtube.com/embed/eyz123"
                                {...register("video_url", {
                                    pattern: {
                                        value:
                ...
                <div className="bg-gray-800 p-6 rounded-lg w-[450px] text-white">
                    ...
                    {selectedImage && (
                        <div className="mt-4 space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-3 mx-h-[250px] overflow-auto">
