...
import BankLogo from 'apps/seller-ui/src/assets/svgs/bank-logo';
                ...
                {activeStep === 1 && (
                    <>
                        {!showOtp ? (
                            ...
                            <input 
                                type="email" 
                                placeholder="l.f.logicforge@gmail.com"
                                className="w-full p-2 border border-gray-300 outline-0 !rounded mb-1"
                                {...register("email", {
