            ...
            <Controller
                ...
                render={({ field }) => (
                    <div className="flex gap-3 flex-wrap">
                        {[...defaultColors, ...customColors].map((color) => {
                            ...
                            return (
                                <button 
                                    ...
                                    className={`w-7 h-7 p-2 rounded-md my-1 flex items-center justify-center border-2 tranasition ${
                        ...
                        <button 
                            type="button" 
                            className="w-8 h-8 flex items-center justify-center rounded-full border-gray-500 bg-gray-800 hover:bg-gray-700 transition"
